...
namespace MercuryHealth.AutomatedTest.Pages
{
    ...
    {
        public NutritionPage(IWebDriver driver, Eyes eyes)
        {
            _driver = driver;
            _eyes = eyes;
        }
        ...
        public DeleteFoodPage ClickDeleteFood(string foodDescription)
        {
            ...
            return new DeleteFoodPage(_driver, _eyes);
        }
            ...
            try
            {
                ...
                if (foodRow.Count() != 0)
                {
                    foreach(var row in foodRow)
                    {
                        ...
                        deleteLink.Click();
                        var deletePage = new DeleteFoodPage(_driver, _eyes);
        ...
        public EditFoodPage ClickEditFoodLink(string foodDescription)
        {
            ...
            return new EditFoodPage(_driver, _eyes);
        }
        #endregion
