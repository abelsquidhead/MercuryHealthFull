...
namespace MercuryHealth.AutomatedTest.Pages
{
    ...
    {
        public ExercisePage(IWebDriver driver, Eyes eyes)
        {
            _driver = driver;
            _eyes = eyes;
        }
        ...
        public CreatePage ClickCreateNewLink()
        {
            ...
            return new CreatePage(_driver, _eyes);
        }
        ...
        public DeleteExercisePage ClickDeleteExercise(string exerciseDescription)
        {
            ...
            return new DeleteExercisePage(_driver, _eyes);
        }
            ...
            try
            {
                ...
                else
                {
                    foreach(var row in foodRow)
                    {
                        ...
                        deleteLink.Click();
                        var deletePage = new DeleteExercisePage(_driver, _eyes);
        ...
        public EditExercisePage ClickEditExerciseLink(string exerciseDescription)
        {
            ...
            return new EditExercisePage(_driver, _eyes);
        }
        #endregion
